  ...
  return (
    <div className='flex h-full flex-col px-3 py-3 md:px-2 '>
        ...
        <div className='flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2'>
            ...
            <button className="flex text-sm transition h-[45px] w-full grow items-center justify-center gap-2 rounded-md bg-[#1d6bac] p-3 font-semibold hover:bg-[#2c88cb] md:flex-none md:justify-start md:p-2 md:px-3">

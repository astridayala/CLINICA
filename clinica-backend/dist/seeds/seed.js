...
async function main() {
    ...
    try {
        ...
        await data_source_1.default.getRepository(treatment_type_entity_1.TreatmentType).save([
            { name: 'Consultas' },
        ...
        await data_source_1.default.getRepository(treatment_status_entity_1.TreatmentStatus).save([
